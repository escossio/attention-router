...
- Provider-neutral integration ingress with authenticated tenant bindings, durable PostgreSQL inbox admission, and a separately gated canonical-event dispatcher; live provider connectors remain disabled by default.
...
## Operational control-plane provisioning
