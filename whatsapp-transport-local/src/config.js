...
function createConfig(env = process.env) {
  ...
  return {
    ...
    otelTracingEnabled: parseBoolean(env.OTEL_TRACING_ENABLED, false),
    otelExporterOtlpEndpoint: env.OTEL_EXPORTER_OTLP_ENDPOINT || null,
    otelExporterOtlpProtocol: env.OTEL_EXPORTER_OTLP_PROTOCOL || 'http/protobuf',
    otelServiceVersion: env.OTEL_SERVICE_VERSION || '0.1.0',
    otelTracesSampler: env.OTEL_TRACES_SAMPLER || 'parentbased_traceidratio',
    otelTracesSamplerArg: env.OTEL_TRACES_SAMPLER_ARG || '1.0',
    otelBatchMaxQueueSize: env.OTEL_BATCH_MAX_QUEUE_SIZE || '2048',
    otelBatchMaxExportBatchSize: env.OTEL_BATCH_MAX_EXPORT_BATCH_SIZE || '512',
    otelBatchScheduleDelayMillis: env.OTEL_BATCH_SCHEDULE_DELAY_MILLIS || '500',
    otelExportTimeoutMillis: env.OTEL_EXPORT_TIMEOUT_MILLIS || '5000',
    otelFlushTimeoutMillis: env.OTEL_FLUSH_TIMEOUT_MILLIS || '1000',
