...
def repository_sessions():
    ...
    reset = text(
        "TRUNCATE TABLE provider_authorizations, client_location_snapshots, "
        "client_sessions, client_session_challenges, device_bootstrap_challenges, "
        "client_devices, client_tenant_memberships, human_auth_continuation_grants, "
